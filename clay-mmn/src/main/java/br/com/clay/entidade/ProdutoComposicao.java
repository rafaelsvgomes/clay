...
@NamedQueries({
	@NamedQuery(name = ProdutoComposicao.LISTAR_PRODUTOS_INCLUSOS, query = "SELECT pc FROM ProdutoComposicao pc WHERE pc.produtoPai.id = :idProduto")
})
public class ProdutoComposicao extends ClayEntidade {
