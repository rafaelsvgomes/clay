...
public class CpfCnpjValidator implements Validator {
    ...
    public void validate(FacesContext arg0, UIComponent arg1, Object valorTela) throws ValidatorException {
    	 String cpfCnpj = getCpfCnpjSemFormatacao(valorTela);
	...
	private String getCpfCnpjSemFormatacao(Object valorTela) {
		String cpfCnpj = String.valueOf(valorTela);
         if (cpfCnpj!= null && !cpfCnpj.equals("") && cpfCnpj.length() <= 14){
        	 cpfCnpj = cpfCnpj.replaceAll("\\.", "").replaceAll("\\-", "");
         }else{
