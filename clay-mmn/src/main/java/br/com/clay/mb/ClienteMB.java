...
public class ClienteMB extends ClayMB {
    ...
    public void iniciarPagamento() {
        // TODO: rafael
        // Na hora de gravar salva a altera√ß√£o efetuada no plano (Ou pode deixar pra alterar s√≥ no cadastro) chama o pagamento.
        // Implementar ativar com bot√£o no listar se for grupo admin.
        if (!FacesContext.getCurrentInstance().isPostback()) {
    ...
    public String salvar() {
        ...
        try {
            ...
            // TODO: rafael - ajustar l√≥gica de enviar email e salvar sincronamente
            if (enviarEmail) {
                try {
    ...
    /**
     * MÈtodo respons·vel por buscar o cep no webService
     * @param e
     * @return String
     * 
     */
    ...
    /**
     * MÈtodo respons·vel por popular os enderecos trago pelo web service
     * @param cep
